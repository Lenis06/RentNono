...
if (!isset($_SESSION['id'])) {
    header("Location: Rentnono/index.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($password_actual) || empty($password_nueva) || empty($password_confirmar)) {
        ...
        $sql = "SELECT password FROM $tabla WHERE id = :id";
        $stmt = $conn->prepare($sql);
        $stmt->execute([':id' => $_SESSION['id']]);
        $usuario = $stmt->fetch(PDO::FETCH_ASSOC);
        
        // En producción usar password_verify()
        if ($usuario && md5($password_actual) === $usuario['password']) {
            // Actualizar contraseña
            $nueva_password_hash = md5($password_nueva); // En producción usar password_hash()
            ...
            <form method="POST" class="modal-formulario">
                <div class="input-grupo">
                    ...
                    <div class="password-container">
                        ...
                        <button type="button" class="btn-ver-password" data-target="password_actual">
                ...
                <div class="input-grupo">
                    ...
                    <div class="password-container">
                        ...
                        <button type="button" class="btn-ver-password" data-target="password_nueva">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="input-grupo">
                    ...
                    <div class="password-container">
                        ...
                        <button type="button" class="btn-ver-password" data-target="password_confirmar">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                </div>
