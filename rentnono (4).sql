...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2025 a las 23:48:40
...
INSERT INTO `usuario_admin` (`id`, `nombre`, `correo`, `password_hash`, `telefono`, `foto_perfil`, `role`, `last_activity`, `creado_en`) VALUES
(1, 'Administrador', 'admin@rentnono.com', '$2y$10$yDwzuj0IFWkJJSSdqAWlDOS5.Z/NpKH1Emaxz1PfTSHaIS4d9qvby', '3825612630', NULL, 'admin', '2025-10-21 18:41:50', '2025-10-21 09:44:43');
...
INSERT INTO `usuario_propietario` (`id`, `nombre`, `sexo`, `dni`, `correo`, `telefono`, `password`, `rol`) VALUES
(6, 'Nery Jair Reinoso', 'masculino', '43344607', 'nery.reinoso.7@gmail.com', '3825456521', '0000', 'propietario'),
(7, 'Amelia Huerta', 'femenino', '15768983', 'amelia@gmail.com', '380467892', '1234', 'propietario'),
(8, 'Rios Lenis', 'femenino', '47462403', 'lenis@gmail.com', '3825278392', '0000', 'propietario');
...
INSERT INTO `usuario_visitante` (`id`, `nombre`, `correo`, `password`, `rol`) VALUES
(1, 'Nery Jair Reinoso', 'nery.reinoso.7@gmail.com', '1234', 'visitante'),
(2, 'Lenis Samira Rios', 'lenis@gmail.com', '0000', 'visitante'),
(4, 'Florencia Rios', 'florenciarios@gmail.com', 'Silnemarei22', 'visitante'),
(5, 'Graciela Vega', 'gachy@gmail.com', 'gachy', 'visitante'),
(6, 'Abril Barrera', 'abril@gmail.com', 'abril', 'visitante'),
(7, 'Lucas Ortiz', 'lucas@gmail.com', 'lucas', 'visitante'),
(8, 'Arturo Nievas', 'arturo@gmail.com', 'arturo', 'visitante'),
(9, 'Ruben Vazquez', 'ruben@gmail.com', 'ruebn', 'visitante'),
(10, 'Nuevo Usuario', 'usuario@gmail.com', 'usuario', 'visitante'),
(11, 'Root', 'root@gmail.com', 'root', 'visitante'),
(12, 'nuevo', 'nuevo@nuevo.com', 'nuevo', 'visitante'),
(13, 'user', 'user@gmail.com', 'user', 'visitante'),
(14, 'Graciela Mercedes Vega', 'graciela@vega.com', 'graciela', 'visitante'),
(15, 'lenis rios', 'lenis@gmail.com', '1234', 'visitante'),
(16, 'Mercedes', 'mecha@gmail.com', '01234', 'visitante');
...
--
ALTER TABLE `opiniones`
  ADD CONSTRAINT `opiniones_ibfk_1` FOREIGN KEY (`propiedad_id`) REFERENCES `propiedades` (`id`);
