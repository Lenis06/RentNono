    ...
    <div id="modalFondoLogin" class="modal-fondo">
        <div class="modal-contenido">
            ...
            <form method=POST action="database/inicio_sesion.php">
                <label for="usuarioLogin">Correo electronico:</label>
            ...
            <form method="POST" autocomplete="off" id="formRegistro">
                ...
                <div class="input-group">
                    ...
                    <div class="input-container">
                        <input type="text" name="nombre" placeholder="Nombre Completo" require>
...
<!--Mensaje Flotante de Usuario Creado Exitosamente-->
